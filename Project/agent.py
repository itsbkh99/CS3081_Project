...
from environment import load_dataset, create_adversarial_dataset, set_target
...
def main():
    ...
    parser.add_argument(
        ...
        help="Dataset name or CSV filename e.g. world_happiness_2026.csv (default: breast_cancer)"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--target", default=None,
        help="Target column for CSV datasets (auto-detected if not set)"
    )
    parser.add_argument(
